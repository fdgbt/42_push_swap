...
The second one is the "checker" program that takes the same list of numbers as input, reads and applies the instructions received in the terminal then finally confirms that the list is correctly sorted (or not...).  
